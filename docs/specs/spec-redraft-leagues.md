...
| `matchups`, `transactions`, `commissioner_actions`, `lineup_swaps` + the F42 set (`league_members`, `team_managers`, `teams`, `league_invites`, `league_weeks`, `league_lists`) | with their first subscriber | `league:<league_id>` | M4+ (PROGRESS F42) |
