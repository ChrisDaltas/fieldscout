 ...
 *
 * ## The copy's promise is real, and it is not a global mark
 *
 * The sub-line — *"Mark players off as they go in your draft and every column
 * updates"* — is the design's own copy and ships verbatim. It is true because
 * **the comparison set is the draft** (plan **D12**): LV.14 fans a drafted tick
 * out across exactly the lists in this comparison — every column on screen —
 * and no further. The handoff's global `toggleDrafted` (*"sets the flag on that
 * player in every list that contains him"*) is **overridden** by Chris,
 * 2026-08-10: *"marking a player as drafted is per user, per list… players will
 * have multiple lists for multiple leagues."* Nothing here promises a mark that
    ...
    <div className="flex max-w-[576px] flex-col gap-3">
      <div>
        ...
        {/* The design's own sub-line, verbatim. "Every column updates" is a
            promise about the comparison, not about your account — see D12 in
