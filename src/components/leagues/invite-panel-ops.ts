 ...
 * A person's real name lives in the private `profiles.full_name` and is
 * rendered on no league surface (ruling 2026-08-05). Never renders an email:
 * profiles carry none, and this is the only identity string a claimed seat
 * ever shows.
 */
