 ...
 * not honor-system): SELECTs each of the 6 seeded template rows from the
...
describe('TS↔DB template equivalence (L.A1.9(5) — local stack, anon read path)', () => {
  ...
  it('the DB holds exactly the six authored templates, rules deep-equal (values, not just keys)', async () => {
