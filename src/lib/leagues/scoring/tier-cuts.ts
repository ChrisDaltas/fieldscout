 ...
 * the six shipped `SCORING_TEMPLATES` rules objects actually reference.
 *
...
/**
 * The `tier_cuts` member of a format-2 rules envelope (§7.3.3.1), as far as
 * SE.1 needs it — one ascending cut list per independent table. SE.2's
 * envelope type reuses this shape rather than restating it (D33/D167: one
 * definition, one home).
 */
